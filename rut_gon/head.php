...
.mobile-menu:hover{background:#6C3598;color:#ffffff;text-decoration:none;}
@media (min-width: 768px) and (max-width: 979px) {.mainWrap{width:768px;}.menu ul{top:37px;}
.menu li a{font-size:12px;padding:8px;}}
@media (max-width: 767px) {
	.mainWrap{width:auto;padding:50px 20px;}.menu{display:none;}.mobile-menu{display:block;margin-top:20px;width: 96.1%;}
...
@media only screen and (max-width: 768px) {	
	...
	.col_1_of_4 ,.col_1_of_4:nth-child(4){
...
@media only screen and (max-width: 640px) {	
	...
	.menu li:hover>ul, ul.sub-menu.list-unstyled.sub-menu2, ul.sub-menu.list-unstyled.sub-menu3 {
		display: none;
	}
/*** Header ****/
	.search_box form input[type="text"] {
