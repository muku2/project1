...
<form method="post" action="admin_process_update.php ">
	<div class="signup">
		<form class="signup-form" autocomplete="off" name="admin">
			...
			<input type="number" class="signup-input" name="sdt" id="sdt"  value=" <?php echo $each['sdt']?>">
			<label class="signup-label">
				Email
			</label>
			...
			<input type="radio" name="cap_do" value="1" style="width: 15%" <?php if($each['cap_do']==1) echo'checked';?>> Admin
			<input type="radio" name="cap_do" value="0" style="width: 15%" <?php if($each['cap_do']==0) echo'checked';?>> Nhân Viên
